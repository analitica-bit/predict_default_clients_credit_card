...
```{r prep}
data <- var_data %>% 
  select(-(c(bill_amt1:bill_amt6, pay_amt1:pay_amt6))) # taking out bill amount 
str(data)
# partition
set.seed(1)
...
## TASK 2 - To build at least 3 models to classify the clients into defaulter or not defaulters



## TASK 3 - to state the kind of parameters that were used and the variables that were important.
The following variable were used: The target variables were variables such as sex, limit balance, 
